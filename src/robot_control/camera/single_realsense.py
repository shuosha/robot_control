    ...
    def run(self):
        ...
        def init_device():
            ...
            try:
                ...
                print(f'[SingleRealsense {self.serial_number}] Color sensor not found, using depth sensor for global time.')
                ...
                for i in range(n_cmd):
                    ...
                    if cmd == Command.SET_COLOR_OPTION.value:
                        try:
                            ...
                            print(f'[SingleRealsense {self.serial_number}] Cannot set color option {command["option_enum"]} to {command["option_value"]}.')
